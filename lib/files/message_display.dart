  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
            'Local Messages for $displayedDate',
            ...
            child: Row(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                    'Cost: $naira${totalLocalCost.toInt()}',
                    style: phoneStyle.copyWith(color: Colors.white),
                  ),
                ),
              ],
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => InternationalMessages(items: addNetworkCodes(internationalMessageList)),
                      ),
                    );
                  },
                  style: ButtonStyle(
