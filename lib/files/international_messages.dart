...
import 'package:birthday_messages/files/message_display.dart';
...
class InternationalMessages extends StatefulWidget {
  final List<List<String>> items;

  const InternationalMessages({super.key, required this.items});

  @override
  State<InternationalMessages> createState() => _InternationalMessagesState();
}


class _InternationalMessagesState extends State<InternationalMessages> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
            'INT\'L Messages for $displayedDate',
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Messages(items: addNetworkCodes(localMessageList)),
                      ),
                    );
                  },
                  style: ButtonStyle(
  ...
  void sendMessages() async {
    ...
    final String result = await callNativeFunction('sendMessages', messagePack);
    setState(() {
